...
7. **FAIL이면 4번(또는 5번)부터 재시도** (최대 `maxAutoRetry`회, 2연속 FAIL만 확정) — pipeline.md와 동일 원칙: 판정서의 실패 사유(axe 위반·콘솔 에러)를 다음 시도에 반영하세요.
...
## 아직 없는 것 (다음 증분)
- `AI-GENERATION-LOG.md` 자동 기록 (03_PHASES.md L108 — 별도 증분으로 승인됨)
